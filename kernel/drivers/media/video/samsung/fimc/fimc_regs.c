...
log_msg(LOG_DBG,"called,sc->bypass(%d),sc->scaleup_h(%d),sc->scaleup_v(%d),\
			sc->main_hratio(%d),sc->main_vratio(%d)\n",\
			sc->bypass,sc->scaleup_h,sc->scaleup_v,\
		S3C_CISCCTRL_MAINHORRATIO(sc->main_hratio),S3C_CISCCTRL_MAINVERRATIO(sc->main_vratio));
