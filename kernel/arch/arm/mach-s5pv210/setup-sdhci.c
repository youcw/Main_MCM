...
#if defined(CONFIG_MACH_SMDKV210) || defined(CONFIG_MACH_CW210)
...
{
	return 0/*!!(readl(S5PV210_GPH1DAT) & 0x01)*/;
	
}
static void setup_sdhci3_gpio_wp(void)
{
	s3c_gpio_cfgpin(S5PV210_GPH1(1), S3C_GPIO_INPUT);
	s3c_gpio_setpull(S5PV210_GPH1(1), S3C_GPIO_PULL_DOWN);
}

static int sdhci3_get_ro(struct mmc_host *mmc)
{
	return !!(readl(S5PV210_GPH1DAT) & 0x02);
}
//添加内容
#endif
...
#if defined(CONFIG_S5PV210_SD_CH3_8BIT)
	.max_width	= 4,
	.host_caps	= MMC_CAP_8_BIT_DATA,
#endif
#if defined(CONFIG_MACH_SMDKV210)|| defined(CONFIG_MACH_CW210)
	.cfg_wp         = setup_sdhci3_gpio_wp,
	.get_ro         = sdhci3_get_ro,
#endif
	.cd_type	= S3C_SDHCI_CD_PERMANENT,
};
#endif
