...
#if defined(CONFIG_S3C6410) || defined(CONFIG_S3C6430) || defined(CONFIG_S5P6440) || defined(CONFIG_S5PC100) || defined(CONFIG_S5PC110) || defined(CONFIG_S5PV210) || defined(CONFIG_S5P6442)
uchar default_environment[/*CFG_*/ENV_SIZE] = {
#else
...
#endif
#ifdef	CONFIG_LCD_TYPE //add...
	"lcdtype="	MK_STR(CONFIG_LCD_TYPE)		"\0"
#endif
