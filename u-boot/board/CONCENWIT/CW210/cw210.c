...
#else	
	SROM_BW_REG &= ~(0xf << 4);
	SROM_BW_REG |= (0<<3) | (0<<2) | (0<<1);
#endif
	SROM_BC1_REG = ((DM9000_Tacs<<28)|(DM9000_Tcos<<24)|(DM9000_Tacc<<16)|(DM9000_Tcoh<<12)|(DM9000_Tah<<8)|(DM9000_Tacp<<4)|(DM9000_PMC<<0));
...
#ifdef CONFIG_MCP_SINGLE
ulong virt_to_phy_cw210(ulong addr)
{
