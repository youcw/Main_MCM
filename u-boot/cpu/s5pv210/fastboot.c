...
fastboot_ptentry ptable_default[] =
{
	...
	},
	{
		...
		.start    = 0x700000,
		.length   = 0x500000,
		.flags    = 0 //FASTBOOT_PTENTRY_FLAGS_WRITE_YAFFS
	},
	{
		.name     = "system",
		.start    = 0xc00000,
...
#define TX_ENDPOINT_MAXIMUM_PACKET_SIZE_1_1  (0x0040)
 ...
 #include <s5pv210.h>
#else
#error "* CFG_ERROR : you have to select V210 for Android Fastboot"
#endif
...
int fastboot_init(struct cmd_fastboot_interface *interface)
{
	...
	device_strings[DEVICE_STRING_PRODUCT_INDEX]       = "cw210";
#else
