...
#ifndef CONFIG_S5PV210
#define CONFIG_S5PV210			1
#endif
...
static inline s5pv210_tsadc * s5pv210_GetBase_tsadc(void)
{
	return (s5pv210_tsadc *)ELFIN_ADC_BASE;
}
...
static inline s5pv210_fb * s5pv210_GetBase_fb(void)
{
	return (s5pv210_fb *)ELFIN_LCD_BASE;
}
