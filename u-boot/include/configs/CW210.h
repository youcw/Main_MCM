 ...
 *
 * Configuation settings for the CONCENWIT CW210(mDirac-III) board.
 *
...
#define CONFIG_CW210						1		/* CONCENWIT CW210 Board */
//#define CONFIG_CMD_MENU						0
#define CONFIG_CONCENWIT_FAT					1
#define CONFIG_OEM_SDREAD					1
//#define CONFIG_CONCENWIT_INIT_CUP			1
#if 1
#define CONFIG_CONCENWIT_LCD					1
#else
#undef CONFIG_CONCENWIT_LCD
#endif

#if 1												//是否使用1GB内存
#define CONFIG_CW210_1G
#else
#undef CONFIG_CW210_1G
#endif

#if 1												//在启动参数里面不加mem=xxx的信息
#define CONFIG_NOT_SET_MEM					1
#else
#undef CONFIG_NOT_SET_MEM
#endif


#ifdef CONFIG_CONCENWIT_LCD
#define CONFIG_CONCENWIT_INPUT					0
#define CONFIG_LCD_TYPE						X800Y480
#else
#undef CONFIG_CONCENWIT_INPUT
...
#if 1
#define CONFIG_CW210_IIC_PM_CHIP			1    	//configs using iic power mangement chip
#else
#undef CONFIG_CW210_IIC_PM_CHIP
#endif
...
/* input clock of PLL */
#define CONFIG_SYS_CLK_FREQ					24000000	/* the CW210 has 24MHz input clock */

#define CONFIG_ENABLE_MMU

#ifdef CONFIG_ENABLE_MMU
#define virt_to_phys(x)						virt_to_phy_cw210(x)
#else
 ...
 */
//串口号在这里是从1开始计算的到4结束。
#define CONFIG_SERIAL1      			    1	/* we use UART1 on CW210 */
//#define CONFIG_SERIAL2      			    2	/* we use UART2 on CW210 */
//#define CONFIG_SERIAL3      			    3	/* we use UART3 on CW210 */
//#define CONFIG_SERIAL4      			    4	/* we use UART4 on CW210 */
...
#define CFG_PROMPT							"tarena # "   /* Monitor Command Prompt       */
...
#define CONFIG_CLK_1000_200_166_133//lhhmodify
...
/*
 * CW210 board specific data
 */

#define CONFIG_IDENT_STRING					" for CW210"
...
//#define MTDPARTS_DEFAULT					"mtdparts=s5pv210-nand:512k@0(bios),512k(params),3m(logo),5m(kernel),-(root)"	/* temporary */ 
//#define CONFIG_BOOTARGS					"console=ttySAC0,115200 mtdparts=s5pv210-nand:512k@0(bios),512k(params),2048k(logo),4m(kernel),-(root) ubi.mtd=4"
...
#if defined(CONFIG_SEIRAL1)
//#define CONFIG_BOOTARGS						"noinitrd ubi.mtd=4 root=ubi0:rootfs rootfstype=ubifs init=/init console=ttySAC0 mem=1G"
#define CONFIG_BOOTARGS						"noinitrd root=/dev/mtdblock3 rootfstype=yaffs2 init=/init console=ttySAC0 mem=1G"
#elif defined(CONFIG_SERIAL2)
//#define CONFIG_BOOTARGS						"noinitrd ubi.mtd=4 root=ubi0:rootfs rootfstype=ubifs init=/init console=ttySAC1 mem=1G"
#define CONFIG_BOOTARGS						"noinitrd root=/dev/mtdblock3 rootfstype=yaffs2 init=/init console=ttySAC1 mem=1G"
#elif defined(CONFIG_SERIAL3)
//#define CONFIG_BOOTARGS						"noinitrd ubi.mtd=4 root=ubi0:rootfs rootfstype=ubifs init=/init console=ttySAC2 mem=1G"
#define CONFIG_BOOTARGS						"noinitrd root=/dev/mtdblock3 rootfstype=yaffs2 init=/init console=ttySAC2 mem=1G"
#elif defined(CONFIG_SERIAL4)
//#define CONFIG_BOOTARGS						"noinitrd ubi.mtd=4 root=ubi0:rootfs rootfstype=ubifs init=/init console=ttySAC3 mem=1G"
#define CONFIG_BOOTARGS						"noinitrd root=/dev/mtdblock3 rootfstype=yaffs2 init=/init console=ttySAC3 mem=1G"
#endif /* CONFIG_SERIALn */
#else
#if defined(CONFIG_SEIRAL1)
//#define CONFIG_BOOTARGS						"noinitrd ubi.mtd=4 root=ubi0:rootfs rootfstype=ubifs init=/init console=ttySAC0 mem=512M"
#define CONFIG_BOOTARGS						"noinitrd root=/dev/mtdblock3 rootfstype=yaffs2 init=/init console=ttySAC0 mem=512M"
#elif defined(CONFIG_SERIAL2)
//#define CONFIG_BOOTARGS						"noinitrd ubi.mtd=4 root=ubi0:rootfs rootfstype=ubifs init=/init console=ttySAC1 mem=512M"
#define CONFIG_BOOTARGS						"noinitrd root=/dev/mtdblock3 rootfstype=yaffs2 init=/init console=ttySAC1 mem=512M"
#elif defined(CONFIG_SERIAL3)
//#define CONFIG_BOOTARGS						"noinitrd ubi.mtd=4 root=ubi0:rootfs rootfstype=ubifs init=/init console=ttySAC2 mem=512M"
#define CONFIG_BOOTARGS						"noinitrd root=/dev/mtdblock3 rootfstype=yaffs2 init=/init console=ttySAC2 mem=512M"
#elif defined(CONFIG_SERIAL4)
//#define CONFIG_BOOTARGS						"noinitrd ubi.mtd=4 root=ubi0:rootfs rootfstype=ubifs init=/init console=ttySAC3 mem=512M"
#define CONFIG_BOOTARGS						"noinitrd root=/dev/mtdblock3 rootfstype=yaffs2 init=/init console=ttySAC3 mem=512M"
#endif /* CONFIG_SERIALn */
